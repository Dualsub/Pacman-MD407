...
WorkspacePath          :=C:/dev/repos/pacman/pacman
ProjectPath            :=C:/dev/repos/pacman/pacman/pacman
...
Objects0=$(IntermediateDirectory)/object.c$(ObjectSuffix) $(IntermediateDirectory)/graphics.c$(ObjectSuffix) $(IntermediateDirectory)/delay.c$(ObjectSuffix) $(IntermediateDirectory)/startup.c$(ObjectSuffix) 
...
PostBuild:
	...
	C:\cseapp\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/pacman Debug/pacman.s19
	C:\cseapp\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/pacman > Debug/pacman.dass
	@echo Done
...
## Objects
##
$(IntermediateDirectory)/object.c$(ObjectSuffix): object.c
	...
	$(CC) $(SourceSwitch) "C:/dev/repos/pacman/pacman/pacman/object.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/object.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/graphics.c$(ObjectSuffix): graphics.c
	...
	$(CC) $(SourceSwitch) "C:/dev/repos/pacman/pacman/pacman/graphics.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/graphics.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/delay.c$(ObjectSuffix): delay.c
	...
	$(CC) $(SourceSwitch) "C:/dev/repos/pacman/pacman/pacman/delay.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/delay.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "C:/dev/repos/pacman/pacman/pacman/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
